...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<uglifier>, ["~> 2.6"])
      s.add_runtime_dependency(%q<execjs>, ["~> 2.0"])
      s.add_runtime_dependency(%q<contracts>, ["~> 0.12.0"])
      s.add_runtime_dependency(%q<hashie>, ["~> 3.4"])
      s.add_runtime_dependency(%q<hamster>, ["~> 2.0"])
      ...
      s.add_dependency(%q<uglifier>, ["~> 2.6"])
      s.add_dependency(%q<execjs>, ["~> 2.0"])
      s.add_dependency(%q<contracts>, ["~> 0.12.0"])
      s.add_dependency(%q<hashie>, ["~> 3.4"])
      s.add_dependency(%q<hamster>, ["~> 2.0"])
